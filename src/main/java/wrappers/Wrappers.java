...
public interface Wrappers {
	...
	/**
	 * This method will launch the given browser and maximise the browser and set
	...
	/**
	 * This method will click the element using link name as locator and do take
	 * snap
	 * 
	...
	/**
	 * This method will click the element using link name as locator and do not take
	 * snap
	 * 
	 * @param name The link name (locator) of the element to be clicked
	 * @author Babu - TestLeaf
